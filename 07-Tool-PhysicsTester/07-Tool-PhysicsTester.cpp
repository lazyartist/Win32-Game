...
//// 07-Tool-PhysicsTester.cpp : 응용 프로그램에 대한 진입점을 정의합니다.
////
//
//#include "stdafx.h"
//#include "07-Tool-PhysicsTester.h"
...
//    LoadStringW(hInstance, IDC_MY07TOOLPHYSICSTESTER, szWindowClass, MAX_LOADSTRING);
...
//    }
//
//    HACCEL hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_MY07TOOLPHYSICSTESTER));
//
//    MSG msg;
//
//    // 기본 메시지 루프입니다:
...
//    wcex.hIcon          = LoadIcon(hInstance, MAKEINTRESOURCE(IDI_MY07TOOLPHYSICSTESTER));
//    wcex.hCursor        = LoadCursor(nullptr, IDC_ARROW);
//    wcex.hbrBackground  = (HBRUSH)(COLOR_WINDOW+1);
//    wcex.lpszMenuName   = MAKEINTRESOURCEW(IDC_MY07TOOLPHYSICSTESTER);

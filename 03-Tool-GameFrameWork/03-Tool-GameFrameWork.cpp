// 03-Tool-GameFrameWork.cpp : 응용 프로그램에 대한 진입점을 정의합니다.
//
	...
	_In_ int       nCmdShow)
{
	...
	LoadStringW(hInstance, IDC_MY03TOOLGAMEFRAMEWORK, szWindowClass, MAX_LOADSTRING);
	...
	g_CGameFrame->Init(g_hWnd, g_hWnd, nFrameTime, g_whClientSize, WindowMode::Window);
